...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/xanimo/dogd/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/xanimo/dogd/mining/cpuminer
```
