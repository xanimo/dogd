...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/xanimo/dogd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/xanimo/dogd/blockchain/fullblocktests
```
